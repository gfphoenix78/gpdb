...
# gpautoctl -m deconfig --single 1 -M 10.123.119.10:7999 -D /home/gpadmin/datadirs/M/gpmonitor -c 10.123.119.8:7001

# MASTER_DATA_DIRECTORY=/home/gpadmin/datadirs/entry/standby-1 PGPORT=7001 gpinitstandby -s 10.123.119.9 -P 7010 -S /home/gpadmin/datadirs/entry/m2 --monitor 10.123.119.10,7999,/home/gpadmin/datadirs/M/gpmonitor
...
function config0() {
gpautoctl -m config -M $MONITOR_HOST:$MONITOR_PORT -D $MONITOR_DATADIR -c $C_HOST:$C_PORT
}
function deconfig() {
gpautoctl -m deconfig -M $MONITOR_HOST:$MONITOR_PORT -D $MONITOR_DATADIR -c $C_HOST:$C_PORT
}
