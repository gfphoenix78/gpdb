				  ...
				  AOTupleId *aoTupleId)
{
	...
	SIMPLE_FAULT_INJECTOR_TABLE("appendonly_delete", RelationGetRelationName(aoDeleteDesc->aod_rel));
				  ...
				  AOTupleId *newAoTupleId)
{
	...
	SIMPLE_FAULT_INJECTOR_TABLE("appendonly_update", RelationGetRelationName(aoUpdateDesc->aoInsertDesc->aoi_rel));
				  ...
				  AOTupleId *aoTupleId)
{
	...
	SIMPLE_FAULT_INJECTOR_TABLE("appendonly_insert", RelationGetRelationName(aoInsertDesc->aoi_rel));
